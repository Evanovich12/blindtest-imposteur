...
function startRound(room) {
  ...
  // Pioche 10 morceaux aléatoires depuis le pool complet (varie à chaque manche/rejoueur)
  const allTracks = room.playlists[room.currentOwner].tracks;
  const tracks = [...allTracks].sort(() => Math.random() - 0.5).slice(0, 10);
